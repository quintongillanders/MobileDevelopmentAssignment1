        ...
        executor.execute(() -> {
            ...
            runOnUiThread(() -> {
                ...
                if (userPassword == null || userRole == null) {
                    tvResult.setText("Please make sure you are registered as an admin");
                    return;
                }
                ...
                if(userPassword.equals(password)) {
                    ...
                    finish();
                        ...
                        Toast.makeText(LoginAdminActivity.this, "You are not an admin, Please make sure you are registered as an admin", Toast.LENGTH_SHORT).show();
